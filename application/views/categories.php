...
foreach($categories as $c)
{
    ...
    echo "<td>";
    echo form_open("home/editcat");
    echo form_hidden("id", $c->id);
    echo "<button type='submit' class='btn btn-sm btn-outline-success' name='edit'>";
    ...
    echo "</td>";
    echo "<td>";
    echo "<a href='" . site_url("home/delcat?id=" . $c->id) . "' class='btn btn-sm btn-outline-danger'>";
